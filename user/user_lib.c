...
void sem_P(int sem) {
  do_user_call(SYS_user_semp, (uint64)sem, 0, 0, 0, 0, 0, 0);
}
void sem_V(int sem) {
  do_user_call(SYS_user_semv, (uint64)sem, 0, 0, 0, 0, 0, 0);
}
int sem_new(int s)
{
  return do_user_call(SYS_user_sem_new, (uint64)s, 0, 0, 0, 0, 0, 0);
}